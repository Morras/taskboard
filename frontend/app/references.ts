//This is a global references file that all the typescript
//files can reference to avoid having to duplicate references
//in multiple typescript files.

/** Third party modules */
///<reference path="../assets/typeDefinitions/angularjs/angular.d.ts" />
///<reference path="../assets/typeDefinitions/angularjs/angular-route.d.ts" />
